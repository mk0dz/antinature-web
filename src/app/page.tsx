...
export default function Home() {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row h-screen bg-white text-black ">
      ...
      <div className="w-full md:w-2/3 p-20 overflow-auto">
        ...
        <p style={{fontFamily: 'Wix Madefor Display'}} className="text-8xl font-thin mb-4">
         Antinature
        </p>
        <p style={{fontFamily: 'Chivo Mono'}} className='text-4xl tracking-wide font-thin mb-4 p-4'>
          py module for playing with antimatter by quantum computing approach
        </p>
        <div className='flex flex-row gap-4 mb-4 content-center'>
          <a href="/docs">
          <button className='bg-black text-white p-2 text-2xl max-w-sm relative pr-12  flex items-center gap-2 hover:bg-gray-800 transition-colors'>
        ...
        <div className="relative">
          <pre className="bg-black text-white p-2 text-2xl max-w-md relative pr-12 flex items-center gap-2">
        ...
        <div className="bg-gray-100 p-4  w-full overflow-auto">
        <code>
{`import numpy as np
